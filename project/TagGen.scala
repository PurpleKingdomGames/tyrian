...
object TagGen {
  ...
  def mergedTemplate(moduleName: String, fullyQualifiedPath: String, contents: String): String =
    s"""package $fullyQualifiedPath
    |
    |import tyrian.Html.text
    |import scala.annotation.targetName
    |
    |// GENERATED by TagGen.scala - DO NOT EDIT
    |trait $moduleName extends $contents {
    |
    |$genTagTag
    |}
    """.stripMargin
  ...
  def gen(moduleName: String, fullyQualifiedPath: String, sourceManagedDir: File): Seq[File] = {
    ...
    val baseFiles = allTags.map { tagList =>
      ...
      val newContents: String =
        template(tagList.namespace, fullyQualifiedPath, contents)
    ...
    val mergedContents: String =
      allTags.map(_.namespace).mkString(" with ")

    val file: File =
      sourceManagedDir / (moduleName + ".scala")

    val newContents: String =
      mergedTemplate(moduleName, fullyQualifiedPath, mergedContents)
  ...
  def rootTags: List[TagType] =
    ...
    def rootTagList = TagList(rootTags, "RootTags")
    def svgTagList  = TagList(svgTags, "SvgTags")

    def allTags: List[TagList] = List(rootTagList, svgTagList)
}
